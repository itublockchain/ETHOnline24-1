    ...
    <div className="mt-6 flex flex-col items-center mb-12">
      ...
      <div className="flex flex-col gap-6 w-[300px] md:w-[450px] lg:w-[600px]">
        <div className="bg-gray-800 p-4 rounded-lg shadow-md flex items-center justify-between gap-4">
          <span className="text-white  w-1/3">Tx</span>
          ...
          <span className="text-white  ml-4">{walletData.tx}</span>
        </div>

        <div className="bg-gray-800 p-4 rounded-lg shadow-md flex items-center justify-between gap-4">
          <span className="text-white  w-1/3">Balance</span>
          <div className="bg-gray-700 w-full h-2 rounded-full overflow-hidden">
            <div
              className="bg-blue-500 h-full transition-all duration-700 ease-out"
          ...
          <span className="text-white  ml-4">{walletData.balance}</span>
        </div>

        <div className="bg-gray-800 p-4 rounded-lg shadow-md flex items-center justify-between gap-4">
          <span className="text-white  w-1/3">erc20/erc721</span>
          <div className="bg-gray-700 w-full h-2 rounded-full overflow-hidden">
            <div
              className="bg-blue-500 h-full transition-all duration-700 ease-out"
          ...
          <span className="text-white  ml-4">{walletData.erc20_721}</span>
        </div>

        <div className="bg-gray-800 p-4 rounded-lg shadow-md flex items-center justify-between gap-4">
          <span className="text-white  w-1/3">Unique Contract</span>
          <div className="bg-gray-700 w-full h-2 rounded-full overflow-hidden">
            <div
              className="bg-blue-500 h-full transition-all duration-700 ease-out"
          ...
          <span className="text-white  ml-4">{walletData.uniqueContract}</span>
        </div>

        <div className="bg-gray-800 p-4 rounded-lg shadow-md flex items-center justify-between gap-4">
          <span className="text-white  w-1/3">Token Number</span>
          <div className="bg-gray-700 w-full h-2 rounded-full overflow-hidden">
            <div
              className="bg-blue-500 h-full transition-all duration-700 ease-out"
          ...
          <span className="text-white  ml-4">{walletData.tokenNumber}</span>
        </div>
      </div>
    </div>
  );
