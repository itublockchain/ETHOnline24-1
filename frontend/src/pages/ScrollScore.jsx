  ...
  if (!layer) {
    return (
      <div className="text-center text-red-500">
        <h2>LAYER2 information not found. Please try again.
        </h2>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-blue-900 to-black text-white p-12">
      <div className="flex items-center justify-center mb-12">
        {layer.logo && (
          <img src={layer.logo} alt={layer.name} className="w-12 h-12 mr-4 animate-pulse" />
        )}
      ...
      <div className="mt-12 max-w-5xl mx-auto space-y-4">
        ...
        <Score label="Unique Contract" transaction={walletData.uniqueContract} />
